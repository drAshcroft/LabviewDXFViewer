...
//		private DXFPolyline thePolyLine = null;
...
//					case 2:				//line
//					{
//						DFXLine temp = (DFXLine) drawingList[obj.indexNo];

//						lePen.Color = temp.AccessContourColor;
//						lePen.Width = temp.AccessLineWidth;

						
//						highlightedRegion.Location = temp.StartPoint;

//						highlightedRegion.Width = temp.StartPoint.X - temp.EndPoint.X;
//						highlightedRegion.Height = temp.StartPoint.Y - temp.EndPoint.Y;
...
//						DXFRectangle temp = (DXFRectangle) drawingList[obj.indexNo];
...
//						DXFCircle temp = (DXFCircle) drawingList[obj.indexNo];
...
//					case 5:				//polyline
//					{
//						DXFPolyline temp = (DXFPolyline) drawingList[obj.indexNo];
...
//					case 6:				//arc
//					{
//						DXFArc temp = (DXFArc) drawingList[obj.indexNo];
...
//				case 2:		//Line
//				{
//					DFXLine line = (DFXLine) drawingList[indexno];
...
//				case 3:		//rectangle
//				{
//					DXFRectangle rect = (DXFRectangle) drawingList[indexno];
...
//				case 4:		//circle
//				{
//					DXFCircle tempCircle= (DXFCircle) drawingList[indexno];
...
//				case 5:		//polyline
//				{
//					DXFPolyline tempPoly = (DXFPolyline) drawingList[indexno];
...
//				case 6:		//arc
//				{
//					DXFArc tempArc = (DXFArc) drawingList[indexno];
...
//			int ix = drawingList.Add(new DFXLine (new Point((int)x1, (int) -y1), new Point((int)x2, (int)-y2) , Color.White, 1));
...
//			thePolyLine = new DXFPolyline (Color.White, 1);
...
//			{
//				thePolyLine.AppendLine (new DFXLine ( (Point)pointList[i-1], (Point)pointList[i],Color.White, 1));
//			}

//			if (openOrClosed == 1)
//				thePolyLine.AppendLine (new DFXLine ( (Point)pointList[numberOfVertices-1], (Point)pointList[0],Color.White, 1));
...
//			int ix = drawingList.Add(new DXFCircle (new Point ((int)x1, (int)-y1), radius, Color.White, Color.Red, 1));
...
//			int ix = drawingList.Add(new DXFArc (new Point ((int)x1, (int)-y1), radius, angle1, angle2, Color.White, Color.Red, 1));
